...
namespace Bai3
{
    ...
    {
        #region Поля
        private FileSizeFormatter sizeFormatter;
        private const int BYTE_IN_KILOBYTE = 1000;
        private const int COLUMN_WIDTH = 120;
        private const int DRAG_DISTANCE = 10;
        
        private string topLevelName = "Computer";                                                              //Имя верхего уровня иерархии файловой системы

        private string[] viewModes = { "Large Icon", "Small Icon", "List", "Details", "Tile" };      //Режимы отображеня
        ...
        private string[] columnsForFiles = { "Name", "Size", "Creation Date", "Modified Date" };              //Столбцы для файлов и каталогов
        private string[] columnsForDrives = { "Name", "Type", "File system", "Total size", "Free" };   //Столбцы для дисков
        ...
        void toolStripComboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            switch (toolStripComboBox1.SelectedItem.ToString())
            {
                ...
                case "Tile":
                    ...
                    break;
                default:
                    MessageBox.Show("Unknown display mode", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    break;
            }
        }

        //====================================================
        //Click on an item in a ListView
        //====================================================
        ...
        void tv_files_AfterLabelEdit(object sender, NodeLabelEditEventArgs e)
        {
            ...
            {
                MessageBox.Show("Unable to rename directory", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Information);
                e.CancelEdit = true;
            }
        }
        ...
        public bool SetFileSystemItems(string path)
        {
            ...
            {
                MessageBox.Show("Could not read directory", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return false;
            }
